...
budgets=(
950 1000 1400 1500 1600 1700 1800 1900 2000 2200 2400 2600 2800 3000 3108
)

# 顺序执行
for b in "${budgets[@]}"; do
    echo "🚀 正在运行: python reg_selection_time_only_one_phase_new.py --budget=${b}"
    python reg_selection_time_only_one_phase_new.py --dataset=devnagari --batch_size=64 --max_epochs=16 --budget=${b}
