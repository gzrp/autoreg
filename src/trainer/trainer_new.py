...
class Trainer(object):
    ...
    def train_epoch(self, dataloader: DataLoader) -> Tuple[float, float, float]:
        ...
        all_y, all_score = [], []  # ✅ 新增用于计算 AUC 的缓存
    ...
    def train(
        ...
        for epoch in range(self.start_epoch+1, self.start_epoch+epochs+1):
            ...
            self.train_bacc_auc_history.append(train_bacc)
    ...
    def save_model(self, path: str):
        state = {
            ...
            "train_bacc_auc_history": self.train_bacc_auc_history,
    ...
    def load_model(self, path: str):
        ...
        self.train_bacc_auc_history = cpt.get("train_bacc_auc_history", [])
