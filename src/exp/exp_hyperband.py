...
# python exp_hyperband.py --dataset adult --batch_size 64 --seed 42 --device cuda --num_cpus 4 --num_gpus 1 --max_concurrent_trials 4 --lr 1e-3 --momentum 0.9 --max_epochs 4 --num_samples 10 --trail_num_cpus 1 --trail_num_gpus 0.1 --trail_metric bacc --trail_mode max --exp_name hyperband --storage ~/ray_results --reduction_factor 2
