...
#7804 9105  10405 11706 13006 15608 18209 20810 23411
26012
)
...
for b in "${budgets[@]}"; do
    ...
    python ../exp7_only_2phase_all.py --dataset=connect --batch_size=64 --max_epochs=16 --budget=${b} --num_workers=4 --device_ids=3 --gpu_ids=3
