...
for b in "${budgets[@]}"; do
    ...
    python ../exp2_2phase.py --dataset=devnagari --batch_size=64 --max_epochs=16 --grace_period=1 --budget=${b} --device_ids=1,1 --gpu_ids=1,1,1,1 --storage="~/autodl-tmp/ray_results"
