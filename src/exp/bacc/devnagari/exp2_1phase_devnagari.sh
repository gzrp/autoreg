...
for b in "${budgets[@]}"; do
    ...
    python ../exp2_1phase.py --dataset=connect --batch_size=64 --max_epochs=16 --grace_period=1 --budget=${b} --device_ids=0,0 --gpu_ids=0,0,0,0 --storage="~/autodl-tmp/ray_results"
