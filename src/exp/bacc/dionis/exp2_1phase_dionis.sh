...
for b in "${budgets[@]}"; do
    ...
    python ../exp2_1phase.py --dataset=dionis --batch_size=256 --max_epochs=32 --grace_period=1 --budget=${b} --device_ids=0,0 --gpu_ids=0,0,0,0 --storage="~/autodl-tmp/ray_results"
