...
3600 4200 4800 5400 6000 6600 7200 8400 9600 12000 14400
18000 21600 25200 27741
)

# 顺序执行
for b in "${budgets[@]}"; do
    echo "🚀 正在运行: python exp_random_2phase.py --budget=${b}"
    python ../exp_random_2phase.py --dataset=dionis --batch_size=256 --max_epochs=32 --grace_period=1 --num_workers=4 --budget=${b} --device_ids=2,3 --gpu_ids=2,3,2,3
