...
#8773 10236 11698 13160 14622 17546 20471 23395 26319
29244
)
...
for b in "${budgets[@]}"; do
    ...
    python ../exp7_only_2phase_all.py --dataset=diabetic --batch_size=128 --max_epochs=16 --budget=${b} --num_workers=4 --device_ids=2 --gpu_ids=2
