...
budgets=(
59 147 293 439 585 732 878 1024 1170 1316
1463 2194 2925 3656 4387  5118 5849 6580 7311 8042
8773 10236 11698 13160 14622 16084 17546 19009 20471 21933 23395 24857 26319 27782 29244
)

# 顺序执行
for b in "${budgets[@]}"; do
    echo "🚀 正在运行: python ../exp7_only_2phase_uniform.py --budget=${b}"
    python ../exp7_only_2phase_uniform.py --dataset=diabetic --batch_size=128 --max_epochs=16 --budget=${b} --num_workers=4 --device_ids=0,1 --gpu_ids=0,1,0,1
