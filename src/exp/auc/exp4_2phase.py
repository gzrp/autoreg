...
if __name__ == '__main__':
    ...
    save_dict_to_file(data=save_result, base_dir=f"/data/ruipeng/workdir/autoreg/.exp_results/exp4/{args.dataset}",
                      prefix=f"{args.exp_name}_{args.budget}_{args.k_n}")

    print("=======================================")
    print(res)

    # append_jsonl(res, f"/data/ruipeng/workdir/autoreg/.exp_results/exp4/logs/{args.dataset}/2phase_{args.budget}.jsonl")
    print("保存结果到文件")
    print("=======================================")