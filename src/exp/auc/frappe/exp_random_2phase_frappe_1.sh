...
for b in "${budgets[@]}"; do
    ...
    python ../exp_random_2phase_1.py --dataset=frappe --batch_size=256 --max_epochs=16 --grace_period=1 --num_workers=4 --budget=${b} --device_ids=2,3 --gpu_ids=2,3,2,3
