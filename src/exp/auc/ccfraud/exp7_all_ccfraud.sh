...
#9804 11438 13072 14706 16340 19608 22876 26144 29412
32680
)
...
for b in "${budgets[@]}"; do
    ...
    python ../exp7_only_2phase_all.py --dataset=ccfraud --batch_size=256 --max_epochs=16 --budget=${b} --num_workers=4 --device_ids=1 --gpu_ids=1
