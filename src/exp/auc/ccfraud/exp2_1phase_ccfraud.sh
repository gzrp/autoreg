...
210 240 270 300 330 360 420 480 540 600 720 840 960 1080
...
for b in "${budgets[@]}"; do
    ...
    python exp2_1phase.py --dataset=ccfraud --batch_size=256 --max_epochs=16 --grace_period=1 --budget=${b} --device_ids=0,1
