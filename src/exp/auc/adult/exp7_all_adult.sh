...
#2920 3405 3890 4375 4860 5835 6805 7780 8750
9720
)
...
for b in "${budgets[@]}"; do
    ...
    python ../exp7_only_2phase_all.py --dataset=adult --batch_size=64 --max_epochs=8 --budget=${b} --num_workers=4 --device_ids=0 --gpu_ids=0
