...
if __name__ == '__main__':
    ...
    legend_map = {
        ...
        "2Phase": "/data/ruipeng/workdir/autoreg/exp/exp2/adult/2phase_time_log_extract.jsonl",
    ...
    plt.ylabel("Balanced ACC (%) on Adult")   # 你可写成 (%)，可选
    ...
    # 保存图片
    save_path = "/data/ruipeng/workdir/autoreg/exp/exp2/adult/slo_2phase_rs.png"
